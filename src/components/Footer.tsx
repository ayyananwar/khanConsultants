...
export default function Footer() {
  ...
  return (
    <footer
      ...
      style={{
        background: 'var(--color-3d6b56)',
        color: designTokens.colors.neutral.white,
      }}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-12 md:py-14">
        <div className="h-1 w-20 sm:w-28 rounded-full mb-6 sm:mb-8" style={{ background: 'linear-gradient(to right, var(--color-f59e0b), var(--color-facc15))' }} />
        ...
        <div className="grid grid-cols-1 gap-8 sm:gap-10 lg:grid-cols-12 lg:gap-12">
          <div className="lg:col-span-4 text-center sm:text-left">
            ...
            <p className="text-sm sm:text-base leading-relaxed max-w-sm" style={{ color: 'var(--color-cfe7d6)' }}>
              One Stop. 10000 Experts. Your Solution Starts Here. From business to property, legal to taxation.
            </p>
            <Link
              to="/contact"
              className="inline-flex items-center justify-center mt-5 px-5 py-2.5 min-h-[44px] rounded-lg text-sm sm:text-base font-semibold bg-amber-400 text-[var(--color-1f3a30)] hover:bg-amber-300 transition-colors duration-200 w-full sm:w-auto shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-300/80 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-3d6b56)]"
            >
              Book a Free Call
            </Link>
          </div>
          ...
          <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 text-left">
            <div>
              ...
              <ul className="space-y-2 text-xs sm:text-sm" style={{ color: 'var(--color-cfe7d6)' }}>
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="flex items-center gap-3 mt-4">
                <a href="https://www.facebook.com/KhanConsultants2025" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-[var(--color-1877f2)] hover:bg-[var(--color-0f6ae6)] text-white flex items-center justify-center transition-colors">
                  <FaFacebookF className="text-sm" aria-hidden="true" />
                </a>
                <a href="https://www.instagram.com/khanconsultants2025/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-gradient-to-br from-[var(--color-f58529)] via-[var(--color-dd2a7b)] to-[var(--color-8134af)] hover:brightness-110 text-white flex items-center justify-center transition-all">
                  <FaInstagram className="text-sm" aria-hidden="true" />
                </a>
                <a href="https://wa.me/916291139691" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-[var(--color-25d366)] hover:bg-[var(--color-1ebe5d)] text-white flex items-center justify-center transition-colors">
        ...
        <div className="pt-6 mt-8" style={{ borderTop: '1px solid rgba(250, 204, 21, 0.28)' }}>
          <div className="flex flex-col sm:flex-row justify-between items-center text-xs sm:text-sm gap-3 sm:gap-0" style={{ color: 'var(--color-cfe7d6)' }}>
